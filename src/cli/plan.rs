...
mod tests {
    ...
    fn active_modules_label_default_matches_standard_pipeline() {
        ...
        let expected = "Accessibility, Accessibility Journey, Best Practices, Dark Mode, Journey, Mobile, Performance, Security, SEO, AI Visibility, Tech Stack, Commerce, UX, Source Quality, Content Visibility".to_string();
        assert_eq!(active_modules_label(&args), expected);
    }
