...
pdf-html-conform-takeaway = Der Score ist aktuell nicht belastbar und fließt nicht in die Gesamtwertung ein.
label-limited-reliability = Eingeschränkt belastbar
pdf-html-conform-heuristic-note = Der HTML5-Schema-Check dieses Moduls kennt aktuell keine RDFa-/Open-Graph-Attribute; Seiten mit Standard-Meta-Tags wie „og:…" erzeugen dadurch False-Positive-Befunde. Der Score fließt deshalb nicht in die Gesamtwertung ein und ist als Hinweiswert, nicht als belastbare Konformitätsaussage zu lesen.
